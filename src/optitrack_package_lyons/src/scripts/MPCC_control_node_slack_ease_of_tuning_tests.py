...
def safety_value_subscriber_callback(msg):
    ...
    if msg.data == 1:
        print('setting_safety_val to publish', msg.data)
...
def simulation_time_callback(msg):
...
def MPCC_controller():
    ...
    simulation_time_subscriber = rospy.Subscriber('simulation_time',Float32, simulation_time_callback)
    ...
    if solver_choice == 1 or solver_choice == 3 or solver_choice == 4:
        ...
        q2 = 0.001  # relative weight of lat error
        ...
        q1 = 0.1  # relative weight of s_dot following
        q2 = 0.1  # relative weight of lat error
        q3 = 0.1  # relative weight of lag error -- this is the extra term that needs to be tuned
    ...
    while not rospy.is_shutdown():
        ...
        output_array_stacked = np.vstack([output_array_stacked, output_array[0,:]])
        ...
        #check if overtake was successfull
    ...
    filename = '/home/lorenzo/OneDrive/PhD/ubuntu_stuff/python_world/MPCC_Lyons/Ease_of_tuning_tests/Ease_of_tuning_'+ solver_name + date + '_' + time + '_q2_' + str(q2) + '.db'
